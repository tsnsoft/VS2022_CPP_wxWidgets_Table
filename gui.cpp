...
MainFrameBase::MainFrameBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText2 = new wxStaticText( this, wxID_ANY, _("Работа с таблицей"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText_Sum = new wxStaticText( this, wxID_ANY, _("нажмите на кнопки ниже"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_button3 = new wxButton( this, wxID_ANY, _("Случайные"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_button7 = new wxButton( this, wxID_ANY, _("Сумма"), wxDefaultPosition, wxDefaultSize, 0 );
